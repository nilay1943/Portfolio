...
export default function Intro() {
  ...
  return (
    ...
    >
      {/* Background layers */}
      <div className={`absolute inset-0 bg-[url('/grid.svg')] opacity-5 transition-opacity duration-500 ${isHovered ? 'opacity-10' : ''}`}></div>
      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="flex-1 text-center md:text-left">
            <h1 className="text-5xl md:text-6xl font-bold mb-6 text-gray-900 transition-all duration-500 hover:scale-105">
              Hi, I'm <span className="text-sky-600 hover:text-sky-700 transition-colors duration-300">Nilay</span>
            </h1>
            <div className="h-[2.5rem] md:h-[3rem] mb-8">
            ...
            <div className="flex gap-4 justify-center md:justify-start">
              <a
                href="#projects"
                className="bg-sky-500 text-white hover:bg-sky-600 px-6 py-3 rounded-lg transition-all duration-300 hover:scale-105 hover:shadow-lg"
              >
                View Projects
              </a>
              <a
                href="#contact"
                className="border border-sky-500 text-sky-500 hover:bg-sky-50 px-6 py-3 rounded-lg transition-all duration-300 hover:scale-105 hover:shadow-lg"
              >
                Contact Me
              </a>
            </div>
          ...
          <div className="flex-1 flex justify-center">
            <div className="relative w-64 h-64 md:w-96 md:h-96 transition-all duration-500 hover:scale-105">
