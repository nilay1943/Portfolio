    ...
    <div className="group relative bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-500 hover:shadow-[0_0_30px_rgba(56,189,248,0.2)] hover:-translate-y-2 border border-gray-100">
      <div className="cursor-pointer h-full">
        ...
        <div className="p-6">
          ...
          <p className="text-gray-600 mb-4 group-hover:text-gray-900 transition-colors duration-300 line-clamp-3">
            {description}
          </p>
  ...
  return (
    <section id="projects" className="py-20 bg-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative">
        <h2 className="text-4xl font-bold text-center mb-4 text-gray-900">Live Projects</h2>
        <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">A collection of my recent work showcasing my expertise in full-stack development</p>
